...
async function main() {
  ...
  const sellerPassword = await hash('SellerPass123!');
  const seller2Password = await hash('Seller2Pass123!');
  const customerPassword = await hash('CustomerPass123!');
  const customer2Password = await hash('Customer2Pass123!');
